...
### 완전한 포터블 사용 (Python 설치 불필요)
- **파일**: `MyTODO_Portable.zip` 다운로드
- **압축 해제**: USB나 원하는 폴더에 압축 해제
- **실행**: `MyTODO.exe` 더블클릭
- **장점**: Python 설치 없이도 완전히 독립적으로 동작

### 배치 파일 사용 (Python 설치 필요)
- **이유**: Python이 설치된 환경에서 더 안정적
- **장점**: 오류 메시지 확인 가능, 디버깅 용이
- **사용법**: `MyTODO.bat` 더블클릭
